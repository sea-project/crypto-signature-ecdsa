...
var (
	...
	order     = new(big.Int).Set(ecc.S256().N)
...
func SignCompact(curve *ecc.KoblitzCurve, key *PrivateKey, hash []byte, isCompressedKey bool) ([]byte, error) {
...
func RecoverCompact(curve *ecc.KoblitzCurve, signature, hash []byte) (*PublicKey, bool, error) {
...
func recoverKeyFromSignature(curve *ecc.KoblitzCurve, sig *Signature, msg []byte,
...
func decompressPoint(curve *ecc.KoblitzCurve, x *big.Int, ybit bool) (*big.Int, error) {
